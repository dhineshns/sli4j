 ...
 * @version $Id$
 */
public final class Slf4jLoggerListener extends AbstractLoggerListener<Logger> {

    public <LI extends AbstractLoggerInjector<Logger>> Slf4jLoggerListener() {
        super(Slf4jLoggerInjector.class);
    }
