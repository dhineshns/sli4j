 ...
 * @version $Id$
 */
public final class Slf4jJdk14LoggingTestCase extends AbstractLoggerInectionTestCase<Logger> {

    private Logger logger;

    @BeforeTest
    public void setUp() {
        super.setUp(new Slf4jJdk14LoggingModule(Matchers.only(TypeLiteral.get(this.getClass()))));
    }
